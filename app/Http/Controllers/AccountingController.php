...
use App\Http\Requests\AccClassRequest;
...
class AccountingController extends Controller
{
    ...
    public function postNewEntry(AccountingRequest $request){
        ...
        return redirect('referents/finances/accounting');
    }

    public function postNewClass(AccClassRequest $request){
    ...
    public function postModifyClass(AccClassRequest $request){

        accClass::where('classID', '=', $request['modifyClassSelect'])
            ->update();
